...
标题若包含两个独立判断，作者只表达其中一个时不得当成认同整个复合命题，应记 related。
例如只看好出海增长，不等于同时认同海外扩张受限；只提醒海外风险，也不等于看好增长。
仅评价细分人群或局部市场，不得推定为认同关于全国整体市场的判断，范围不匹配时记 related。
反讽不可按字面计为倡议，个案不能自动推断为对普遍判断的认同；既不认可也不反对不能算反对。
减少用车、暂缓买车、从油车转买电车是不同判断；仅描述油转电或不开车，不得计作汽车总体购车需求受限。
只说车耐用或换车频率低，不足以确认国内市场饱和；希望企业淘汰不等于预测企业将淘汰。
保留原文转折，例如先说无需换车又说已订新车，不能只摘前半句确定立场。
没有时间范围一致的直接否定，长期增长不自动反对近期增量收窄，难度提高不自动反对仍有增长空间。
反讽、玩笑或语境不明而无法确认认真立场时记 related；作者明确以记忆可靠性为前提认同解释时记 conditional。
